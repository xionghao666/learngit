	...
	<div class="row-fluid" id="main">
		<div class="span8 offset2">		
		    <form class="form-search fr" action="<?php echo U('index');?>" method="get">
		    	<input type="text" name="topic" value="<?php echo ($_GET['name']); ?>" class="input-medium" placeholder="话题">
			...
			<table class="table table-striped">
				...
				<tbody>
				 <?php if(!empty($topiclist)): if(is_array($topiclist)): foreach($topiclist as $key=>$val): ?><tr>
						<td><?php echo ($val["id"]); ?></td>
						<td><?php echo ($val["topic"]); ?></td>
						<td><img width="50px" src="/NO2V2/Public/images/<?php echo ($val["picname"]); ?>" alt=""></td>
						
						
						<td>
							<a href="<?php echo U('Topic/del',array('id'=>$val['id']));?>">删除</a> 
						</td>

	...
	<div class="row-fluid" id="main">
		<div class="span8 offset2">		
			...
			<table class="table table-striped">
				...
				<tbody>
				 <?php if(!empty($adlist)): if(is_array($adlist)): foreach($adlist as $key=>$val): ?><tr>
						<td><?php echo ($val["id"]); ?></td>
						<td><img src="/NO2V2/Public/guanggao/img/<?php echo ($val["picname"]); ?>" alt="" width="60px" height="50px"></td>
						<td><?php echo ($val["url"]); ?></td>
						<td><a href="<?php echo U('Ad/huan',array('id'=>$val['id']));?>"><?php echo ($val["start"]); ?></a></td>
						<td>
							<a href="<?php echo U('Ad/del',array('id'=>$val['id']));?>">删除</a> 
							<a href="<?php echo U('Ad/edit',array('id'=>$val['id']));?>">修改</a> 
						</td>

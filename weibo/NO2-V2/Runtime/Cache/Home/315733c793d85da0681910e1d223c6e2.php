  ...
  <div id="banner">
    <table width="765" border="0" cellpadding="0" cellspacing="0" id="tb1">
      <tr>
        ...
        <img src="/NO2V2/Public/Uploads/<?php echo ($info['picname']); ?>" width="90" height="90" alt="" /></td>
        <td height="60" class="td3"><font color="#000000" size="3"><b>粉丝数量（<?php echo ($count); ?>）</b></font></td>
    ...
    <table width="200" border="0" cellpadding="0" cellspacing="0" id="tb2">
      ...
      <tr>
        <td height="60" class="font2" width="120"><br /><font color="black" size="3" face="微软小黑"><b>　　<?php echo ($wbcount); ?>&nbsp; <?php echo ($countgz); ?>&nbsp; <?php echo ($fscount); ?></b></font>
        <br />
      ...
      <tr>
        ...
        <br /> 
        &nbsp;&nbsp;&nbsp;<font color="#666666" size="3">关注我的</font></td>
      </tr>
      <?php if(is_array($userinfo)): foreach($userinfo as $key=>$val): ?><tr>

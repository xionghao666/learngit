    ...
    <input type="hidden" name="id" value="<?php echo ($_SESSION['home']['id']); ?>">
     <table width="565" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         <td class="le"></td>
         <td class="ld">当前密码</td>
         <td class="if"><input name="oldpass" type="password" class="la" id="userId" placeholder="请输入当前密码" style="font-size:15px" /></td>
         <td></td>
       </tr>
       <tr>
         <td class="le"></td>
         <td class="ld">新密码</td>
         <td class="if"><input name="password" type="password" class="la" id="passWord" placeholder="请输入新密码" style="font-size:15px"/></td>
         <td></td>
       </tr>
        <tr>
         <td class="le"></td>
         <td class="ld">新密码</td>
         <td class="if"><input name="repass" type="password" class="la"  placeholder="请再次输入新密码" style="font-size:15px"/></td>
         </td>
         <td></td>
       </tr>
       <tr>

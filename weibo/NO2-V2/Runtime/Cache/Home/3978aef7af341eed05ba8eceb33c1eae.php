    ...
    <div id="mainBanner">
      ...
      <div id="mainBannerTop">
        ...
        <div id="mainBannerTopIssue">
          ...
          <div id="mainBannerTopIssuePoint">转发微博
          </div>
          ...
          <?php if($result1 != null): ?><textarea name="text" rows="4" class="Size" id="textfield2"  style="overflow:hidden;border:1px #0CF solid;" onkeyup="calNum(this,counter1,0)">//@<?php echo ($result1["nickname"]); ?>:<?php echo ($result1["text"]); ?></textarea>
          <?php else: ?>
          <textarea name="text" rows="4" class="Size" id="textfield2"  style="overflow:hidden;border:1px #0CF solid;" onkeyup="calNum(this,counter1,0)"></textarea><?php endif; ?>

          <input type="hidden" name="tid" value="<?php echo ($result["id"]); ?>"></input>
          <input type="hidden" name="ttid" value="<?php echo ($result1["id"]); ?>"></input>
          </div>
        ...
        <div id="mainBannerContent">
            <!--个人展示-->
                <div class="stateShowWord">
                  <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                    <tr>
                      <td width="70" align="center" valign="top">
                        <a href="#">
                          <img width="50px" src="/NO2V2/Public/Uploads/<?php echo ($result["head"]); ?>">
                      </td>
                      <td width="380" ><a href="#">@<?php echo ($result["nickname"]); ?>:</a>
                        <!--会员标志图片-->
                        <!-- 
                  ...
                  <?php if($result['picname'] != null): ?><div class="stateImgShow">
                    <img width="100px" src="/NO2V2/Public/Uploads/<?php echo ($result["picname"]); ?>" />
                    </div><?php endif; ?>  

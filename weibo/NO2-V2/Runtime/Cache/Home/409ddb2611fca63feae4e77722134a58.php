  ...
  <div id="banner">
    <table width="765" border="0" cellpadding="0" cellspacing="0" id="tb1">
      <tr>
        ...
        <img src="/NO2V2/Public/images/weimi.jpg" width="90" height="90" alt="" /></td>
        <td height="60" class="td3"><font color="purple" size="3"><b>微博红人（<?php echo ($count); ?>）</b></font></td>
      ...
      <?php if(is_array($result)): foreach($result as $key=>$val): ?><tr>
       ...
       <div id="focus1">
       <?php if($val['gz'] == '已关注'): ?><img src="/NO2V2/Public/images/ok.png" alt="" width="16" height="16" align="texttop" />
       <?php else: ?><img src="/NO2V2/Public/images/err.png" alt="" width="16" height="16" align="texttop" /><?php endif; ?>
       <?php echo ($val["gz"]); ?><a href="<?php echo U('person/qxgz',array('id'=>$val['id']));?>"><?php echo ($val["gz1"]); ?></a></div></td>
      </tr><?php endforeach; endif; ?>
      
      <tr>
        <td height="35" class="td2"><?php echo ($pageButton); ?></td>
    ...
    <table width="200" border="0" cellpadding="0" cellspacing="0" id="tb2">
        ...
        <td height="65" align="left" class="font2">
           <!-- 粉丝页面用户头像 -->
            <div id="mainRightPostionFirstLineIcon" style="overflow:hidden;border-radius:50px;width:80px;height:80px;">
                    ...
                    <a href="#"><img src="/NO2V2/Public/Uploads/<?php echo ($_SESSION['home']['picname']); ?>" alt="" width="90" height="90" align="absmiddle" title="" border="0" /></a>
                    
            </div>　
                    <a href="<?php echo U('person/index',array('id'=>$info['id']));?>"><?php echo ($_SESSION['home']['nickname']); ?></a>
        <!-- 　　用户个性签名 -->
        <br />个性签名:<?php echo ($_SESSION['home']['sign']); ?></td>
      </tr>
      <tr>
        <td height="60" class="font2" width="120"><br /><font color="black" size="3" face="微软小黑"><b>　　<?php echo ($_SESSION['home']['textnum']); ?>&nbsp; <?php echo ($_SESSION['home']['gznum']); ?>&nbsp; <?php echo ($_SESSION['home']['fsnum']); ?></b></font>
        <br />
      ...
      <tr>
        ...
        <br /> 
        &nbsp;&nbsp;&nbsp;<font color="#666666" size="3">大咖展示</font></td>
      </tr>
      <?php if(is_array($result)): foreach($result as $key=>$val): ?><tr>

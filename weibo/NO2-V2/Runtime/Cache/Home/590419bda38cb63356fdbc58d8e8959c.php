   ...
   <div id="main">
    ...
    <div id="mainBanner">
            ...
            <div id="mainBannerTitle">
                ...
                <div id="mainBannerTitleWord"><b>提到我的</b>
                </div>
            </div> 
            <!--不同人的内容-->
        <div id="mainBannerContent">
            <!--个人展示-->
            <?php if($result == null): ?><font style="font-size: 20px;color:purple;">还没有人AT我哦！</font><?php endif; ?>
            <?php if(is_array($result)): foreach($result as $key=>$val): ?><div class="stateShow" onmouseover="stateMouseOver(this)" onmouseout="stateMouseOut(this)">
                <div class="stateShowWord">
                  <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                    <tr>
                      <td width="70" align="center" valign="top">
                        <a href="<?php echo U('Person/index',array('id'=>$val['uid']));?>">
                          <img src="/NO2V2/Public/Uploads/<?php echo ($val["head"]); ?>" alt="" width="48" height="48" />
                        </a>
                      </td>
              ...
              <?php if($val['repost'] != null): ?><td bgcolor="gray"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Person/index',array('id'=>$val['repost']['uid']));?>"><img src="/NO2V2/Public/Uploads/<?php echo ($val['repost']["head"]); ?>" width="30px"><b style="font-weight:bold;"></a>&nbsp;<a href="<?php echo U('Person/index',array('id'=>$val['repost']['uid']));?>">@<?php echo ($val['repost']["nickname"]); ?></a>:</b><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($val['repost']["text"]); ?><br/><br/></td><br/><?php endif; ?>
                ...
                <div class="stateOp">
                  ...
                  <a class="opState" href="<?php echo U('praise',array('id'=>$val['id']));?>"><?php echo ($val["praiseButton"]); ?>(<?php echo ($val["praisenum"]); ?>)</a>

   ...
   <div id="main">
    ...
    <div id="mainBanner">
            ...
            <div id="mainBannerTitle">
                ...
                <div id="mainBannerTitleWord"><b>我发的私信</b>
                </div>
                <!--首页提示与隐藏-->
        ...
        <div id="mainBannerContent">
            <!--个人展示-->
                ...
                <div class="stateImgShow">
                  <!--微博附带图片-->
                  <!-- <img src="/NO2V2/Public/images/state1.jpg" /> -->
                </div>  
               ...
               <!--  <div class="stateOp">
                ...
                <div id="mainBannerContent2PeopleWordBack">
                   ...
                   <?php if(is_array($chatlist)): foreach($chatlist as $k=>$val): ?><tr>
                        ...
                        我&nbsp;对<a href="<?php echo U('Person/index',array('id'=>$val['getid']));?>"><?php echo ($val["getnickname"]); ?></a>&nbsp;说：
                        </td>
                      </tr>
                      <tr></tr>
                      <tr></tr>

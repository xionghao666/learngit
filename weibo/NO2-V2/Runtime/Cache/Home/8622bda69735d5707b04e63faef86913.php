...
<script language="javascript" src="/NO2V2/Public/script/trim.js" ></script>
    ...
    <div id="mainBanner">
        ...
        <div id="mainBannerContent">
            <!--话题微博展示-->
            <?php if($result == null): ?><font style="font-size: 20px;color: purple;">很抱歉暂无数据。</font><?php endif; ?>
            <?php if(is_array($result)): foreach($result as $key=>$val): ?><br/><br/><br/>
                ...
                <br/><br/>
                    ...
                    <a class="opState" href="<?php echo U('Index/del',array('id'=>$val['id']));?>"><?php echo ($val["delButton"]); ?></a>

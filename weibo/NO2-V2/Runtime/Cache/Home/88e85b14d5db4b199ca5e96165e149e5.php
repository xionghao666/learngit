  ...
  <div id="banner">
    <table width="765" border="0" cellpadding="0" cellspacing="0" id="tb1">
      <tr>
        ...
        <img src="/NO2V2/Public/Uploads/<?php echo ($info["picname"]); ?>" width="80" height="80" alt="" /></td>
        <td height="60" class="td3"><font color="#000000" size="3"><b>关注用户数量（<?php echo ($count); ?>）</b></font></td>
        <td rowspan="7" class="td1 height"></td>
      </tr>
      <tr>
        <td height="47" align="center" valign="middle" bgcolor="#e3f1fa" class="td2 font1">搜索</td>
       <td height="45" align="center" valign="middle" bgcolor="#e3f1fa" class="td4 font1"> 结果</td>
      ...
      <div id="focus1"><?php if($val['gz'] == '已关注'): ?><img src="/NO2V2/Public/images/ok.png" alt="" width="16" height="16" align="texttop" />
    ...
    <table width="200" border="0" cellpadding="0" cellspacing="0" id="tb2">
        ...
        <td height="65" align="left" class="font2">
           <!-- 粉丝页面用户头像 -->
            <div id="mainRightPostionFirstLineIcon" style="overflow:hidden;border-radius:50px;width:80px;height:80px;">
                    ...
                    <a href="#"><img src="/NO2V2/Public/Uploads/<?php echo ($info["picname"]); ?>" alt="" width="90" height="90" align="absmiddle" title="" border="0" /></a>
     ...
     <tr>
        <td height="60" width="180" class="font2"><br /><font color="#cccccc" size="3" face="微软小黑"><b>　　<?php echo ($_SESSION['home']['textnum']); ?>&nbsp;    
            <?php echo ($_SESSION['home']['gznum']); ?>&nbsp;    
            <?php echo ($_SESSION['home']['fsnum']); ?></b></font>
        <br />

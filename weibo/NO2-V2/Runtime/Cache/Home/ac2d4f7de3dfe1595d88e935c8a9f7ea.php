...
<script language="javascript" src="/NO2V2/Public/script/trim.js" ></script>
    ...
    <div id="mainBanner">
        ...
        <div id="mainBannerTop">
            ...
            <form action="<?php echo U('add');?>" method="post" name="myform" enctype="multipart/form-data">
        ...
        <div id="mainBannerContent">
            <!--微博展示-->
            <?php if(is_array($result)): foreach($result as $key=>$val): ?><br/><br/><br/>
                ...
                <div class="stateOp">
                <br/><br/>
                    <a class="opState" href="<?php echo U('collect',array('id'=>$val['id']));?>"><?php echo ($val["collectButton"]); ?></a>

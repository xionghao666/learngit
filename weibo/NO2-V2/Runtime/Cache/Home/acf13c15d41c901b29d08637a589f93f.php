    ...
    <div id="mainBanner">
        ...
        <div id="mainBannerTop">
            ...
            <div id="demo1" class="slideBox">
                <ul class="items">
                    <li><a href="http:www.soso.com"><img src="/NO2V2/Public/guanggao/img/1.jpg" width="565" height="245"></a></li>
                    <li><a href="http:www.soso.com"><img src="/NO2V2/Public/guanggao/img/2.jpg" width="565" height="245"></a></li>
                    <li><a href="http:www.soso.com"><img src="/NO2V2/Public/guanggao/img/3.jpg" width="565" height="245"></a></li>
                    <li><a href="http:www.soso.com"><img src="/NO2V2/Public/guanggao/img/4.jpg" width="565" height="245"></a></li>
                    <li><a href="http:www.soso.com"><img src="/NO2V2/Public/guanggao/img/5.jpg" width="565" height="245"></a></li>
                </ul>
            </div>
        ...
        <div id="mainBannerContent">
            <!--个人展示-->
            <?php if(is_array($textlist)): foreach($textlist as $key=>$val): ?><br/><br/><br/>
                <div class="stateShowWord">
                    <table width="450" border="0" cellpadding="0" cellspacing="0" class="stateTable">
                    <tr>
                        <td width="70" align="center" valign="top">
                            <a href="<?php echo U('Person/index',array('id'=>$val['uid']));?>"><img src="/NO2V2/Public/Uploads/<?php echo ($val["head"]); ?>" alt="" width="48" height="48" /></a>
                        </td>
                ...
                <?php if($val['picname'] != null): ?><div class="stateImgShow">
                    ...
                    </div><img class="big" width="150px" src="/NO2V2/Public/Uploads/<?php echo ($val["picname"]); ?>" /> 
                    </div><?php endif; ?>
                <?php if($val['repost'] != null): ?><td><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Person/index',array('id'=>$val['repost']['uid']));?>"><img src="/NO2V2/Public/Uploads/<?php echo ($val['repost']["head"]); ?>" width="30px"><b style="font-weight:bold;"></a>&nbsp;<a href="<?php echo U('Person/index',array('id'=>$val['repost']['uid']));?>">@<?php echo ($val['repost']["nickname"]); ?></a>:</b><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($val['repost']["text"]); ?><br/><br/></td>
                ...
                <div class="stateOp">
                <br/><br/>
                    <a class="opState" href="<?php echo U('Collect/collect',array('id'=>$val['id']));?>"><?php echo ($val["collectButton"]); ?></a>

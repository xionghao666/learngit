   ...
   <div id="main">
    ...
    <div id="mainBanner">
            ...
            <div id="mainBannerTitle">
                ...
                <div id="mainBannerTitleWord"><b>评论我的</b>
                </div>
            </div> 
            <!--不同人的内容-->
        <div id="mainBannerContent">
          <?php if($result == null): ?><font style="font-size: 20px;color:purple;">还没有人评论我哦！</font><?php endif; ?>
         <?php if(is_array($result)): foreach($result as $k=>$val): ?><br/><br/>
            <div id="mainBannerContent2PeopleWordBack">
              <table width="400" border="1" style="border-color: #CCCCCC" cellpadding="0" cellspacing="0" align="center" >
              <tr>
                <td><a href="#" class="a1">@<?php echo ($val["sendname"]); ?></a> 对你说：<p style="width: 200px;overflow: hidden ;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($val["text"]); ?></p><span style="color:#ccc" ><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发表于 <?php echo ($val["addtime"]); ?></b></span>   
              ...
              <div id="huifu" style="display: none;">
                ...
                <div align="center" id="huifu_biaoti">回复评论<br/>
                </div>
                <form  action="<?php echo U('Comment/reply');?>" method="post" >
                  <div align="center">
                    <textarea autofocus name="text" rows="3" cols="50"  style="overflow:hidden;border:1px #0CF solid;"></textarea>
